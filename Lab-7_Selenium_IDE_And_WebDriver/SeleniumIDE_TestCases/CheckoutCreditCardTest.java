...
public class CheckoutCreditCardTest {
  ...
  public void checkoutCreditCard() {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector("*[data-test=\"nav-categories\"]"));
      Actions builder = new Actions(driver);
    ...
    driver.findElement(By.cssSelector("app-payment .col-md-6")).click();
    driver.findElement(By.cssSelector("*[data-test=\"payment-method\"]")).click();
    {
      ...
      dropdown.findElement(By.xpath("//option[. = 'Gift Card']")).click();
    }
    driver.findElement(By.cssSelector("*[data-test=\"payment-method\"]")).click();
    {
      WebElement dropdown = driver.findElement(By.cssSelector("*[data-test=\"payment-method\"]"));
